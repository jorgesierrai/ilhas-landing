...
> ⚠️ **Decisión pendiente de Jorge.** La línea de identidad no existe todavía. Tres candidatas, sacadas de su propia tesis — **no elijas tú, pregúntale**:
>
> - *"El método con el que se construyen productos que mueven millones, apuntado a tu trabajo."*
> - *"No te enseñamos a usar IA. Te enseñamos a pensar para que la IA valga algo."*
> - *"El método es el barco. Tu área es la isla. Nosotros ya hicimos el viaje."*
...
**03 · El método en cinco pasos, versión corta**
...
**07 · Bloque secundario — servicios financieros y consejería**
...
3. **Casos** — la tabla de linaje, presentada como portafolio:
   ...
   |---|---|
   | **Stampay** | Conciliación bancaria automática (SAT/CFDI ↔ movimientos). Eliminó un proceso manual de 2–3 días por cierre |
   | **Nomcont** | Reemplazó hojas de cálculo dispersas por un ledger estructurado y auditable |
   | **Cometa · AI Data Concierge** | Interfaz en lenguaje natural sobre la base financiera: "¿cuánto entró hoy?" → respuesta al instante |
   | **Nomada** | HRIS y nómina construidos desde cero |
   | **Paystand** | AR/AP en pagos B2B: Smart Lockbox y Spend Card, dos productos 0→1 |
   | **Factumizer** | Automatización de facturas CFDI, de idea a producción en menos de una semana |
