...
> IA" hasta el 5 sep 2026— y va **sin punto final**, las dos cosas por decisión
> de Jorge. El punto se quitó porque, al ir fuera del `<span>` con degradado (que
> es `inline-block`), a partir de ~1200 px caía solo en su propio renglón. Y
