...
export const MEDIOS: SlotMedio[] = [
  ...
  },
  {
    ...
    prioridad: 1,
    objecion: "«¿Y tú qué has construido?» · «¿Tienes track record real?»",
    alt: "Pantalla de Cometa con avisos a clientes por notificación push y WhatsApp",
    caption: "Cometa · avisos a clientes",
    pesoMaxKB: 400,
    notas:
  ...
  },
  {
    ...
    prioridad: 1,
    objecion: "«¿Y tú qué has construido?» · «¿Tienes track record real?»",
    alt: "Pantalla de cálculo de nómina de Nomada",
    caption: "Nomada · nómina y timbrado",
    pesoMaxKB: 400,
  ...
  },
  {
    ...
    prioridad: 1,
    objecion: "«¿Y tú qué has construido?» · «¿Tienes track record real?»",
    alt: "Pantalla de cuentas por cobrar y por pagar de Paystand",
    caption: "Paystand · cuentas por cobrar y por pagar",
    pesoMaxKB: 400,
